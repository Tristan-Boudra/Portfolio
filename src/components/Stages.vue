<template>
  <div class="rounded-lg shadow-[0_5px_25px_-3px_rgba(0,0,0,0.1)] hover:shadow-[0_5px_25px_-3px_rgba(0,0,0,0.3)] transition duration-500 hover:ease-in-out h-full p-5">
    <section class="">
      <div class="flex flex-col">
        <h1 class="text-2xl font-bold p-2 mb-5">{{ data.name }}</h1>
        <img class="mx-auto w-6/12 h-auto rounded-lg mb-5 shadow-[0_5px_25px_-3px_rgba(0,0,0,0.2)] transition duration-500 hover:scale-110" v-if="this.data.img" :src="require(`@/assets/${data.img}.webp`)" alt="image stages">
        ...
        <div class="flex flex-row flex-wrap mx-auto p-3 align-items">
